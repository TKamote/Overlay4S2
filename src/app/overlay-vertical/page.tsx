...
const MATCH_ID = "overlay4s1-vertical";
...
const CreatorOverlay4VerticalPage = () => {
        ...
        >
          <div className="flex w-full items-stretch overflow-visible">
            <FoldedBar side="red" className="rounded-l-sm pl-1">
              ...
              <div className={`${SCORE_CELL_CLASS} text-[47px] w-14`}>{m.player1Score}</div>
            </FoldedBar>
            ...
            <FoldedBar side="blue" className="rounded-r-sm pr-1">
              <div className={`${SCORE_CELL_CLASS} text-[47px] w-14`}>{m.player2Score}</div>
              <button
                type="button"
...
export default CreatorOverlay4VerticalPage;
